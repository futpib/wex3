...
it("Trade", () => __awaiter(this, void 0, void 0, function* () {
    const pair = { from: _1.Valute.BTC, to: _1.Valute.LTC };
    const rate = 11;
    const amount = 567;
    expect(yield api.Trade(pair, _1.OrderType.Buy, rate, amount)).toBe(ret);
...
it("ActiveOrders", () => __awaiter(this, void 0, void 0, function* () {
    const pair = { from: _1.Valute.BTC, to: _1.Valute.ETH };
    expect(yield api.ActiveOrders(pair)).toBe(ret);
