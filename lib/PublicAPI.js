...
class PublicAPI {
    ...
    info() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch("https://btc-e.com/api/3/info");
    ...
    ticker(pair) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch("https://btc-e.com/api/3/ticker/" + pair);
    ...
    depth(pair) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch("https://btc-e.com/api/3/depth/" + pair);
            return (yield response.json())[pair];
        });
    }
    /**
    ...
    trades(pair) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch("https://btc-e.com/api/3/trades/" + pair);
            return (yield response.json())[pair];
        });
    }
}
